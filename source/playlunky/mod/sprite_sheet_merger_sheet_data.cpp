...
void SpriteSheetMerger::MakeMonstersTargetSheet()
{
    ...
    std::vector<MonsterSheet> sheets{
        { "Data/Textures/monstersbasic01.png", {
          ...
          { { "Monsters/golden_monkey.png", { TileMapping{ .SourceTile{ 0, 0, 128, 128 }, .TargetTile{ 1408, 1280, 1536, 1408 } }, TileMapping{ .SourceTile{ 0, 0, 128, 128 }, .TargetTile{ 1920, 1280, 2048, 1408 } } } } } },
        { "Data/Textures/monstersbasic02.png", {
          ...
          { { "Monsters/cave_man.png", { TileMapping{ .SourceTile{ 0, 0, 1024, 128 }, .TargetTile{ 0, 896, 1024, 1024 } }, TileMapping{ .SourceTile{ 0, 128, 256, 256 }, .TargetTile{ 1024, 896, 1280, 1024 } } } } } },
        ...
        { "Data/Textures/monsters01.png", {
          ...
          { { "Monsters/witch_doctor.png", { TileMapping{ .SourceTile{ 0, 0, 256, 128 }, .TargetTile{ 1536, 1280, 1792, 1408 } } } } } },
        { "Data/Textures/monsters02.png", {
          ...
          { { "Monsters/jiangshi.png", { TileMapping{ .SourceTile{ 0, 0, 128, 128 }, .TargetTile{ 1152, 0, 1280, 128 } } } }, { "Monsters/female_jiangshi.png", { TileMapping{ .SourceTile{ 0, 0, 128, 128 }, .TargetTile{ 1152, 768, 1280, 896 } } } }, { "Monsters/hermit_crab.png", { TileMapping{ .SourceTile{ 0, 0, 768, 128 }, .TargetTile{ 1280, 512, 2048, 640 } }, TileMapping{ .SourceTile{ 768, 0, 896, 128 }, .TargetTile{ 1408, 640, 1536, 768 } }, TileMapping{ .SourceTile{ 0, 128, 512, 256 }, .TargetTile{ 1536, 640, 2048, 768 } } } } },
          std::vector<SourceSheet>{ SourceSheet{ .Path{ "Data/Textures/Entities/Critters/blue_crab.png" }, .Size{ 384, 256 }, .TileMap = std::vector<TileMapping>{ { { 0, 0, 384, 128 }, { 768, 1664, 1152, 1792 } }, { { 0, 128, 384, 256 }, { 1152, 1664, 1526, 1792 } } } } } },
        { "Data/Textures/monsters03.png", {
          ...
          { { "Monsters/fire_frog.png", { TileMapping{ .SourceTile{ 0, 0, 256, 128 }, .TargetTile{ 640, 1538, 896, 1664 } } } } },
          {
              SourceSheet{ .Path{ "Data/Textures/Entities/Monsters/olmite_armored.png" }, .Size{ 512, 384 }, .TileMap = std::vector<TileMapping>{
                                                                                                                 { { 0, 0, 512, 128 }, { 0, 1024, 512, 1152 } },
                                                                                                                 { { 0, 128, 512, 256 }, { 512, 1024, 1024, 1152 } },
                                                                                                                 { { 0, 256, 256, 384 }, { 1024, 1024, 1280, 1152 } },
                                                                                                             } },
              SourceSheet{ .Path{ "Data/Textures/Entities/Monsters/olmite_helmet.png" }, .Size{ 512, 640 }, .TileMap = std::vector<TileMapping>{ { { 0, 0, 512, 128 }, { 0, 1152, 512, 1280 } }, { { 0, 128, 512, 256 }, { 512, 1152, 1024, 1280 } }, { { 0, 256, 256, 384 }, { 1024, 1152, 1280, 1280 } }, { { 256, 256, 512, 384 }, { 0, 1280, 256, 1408 } }, { { 0, 384, 512, 512 }, { 256, 1280, 768, 1408 } }, { { 0, 512, 128, 640 }, { 768, 1280, 896, 1408 } } } },
          } },
    };
...
void SpriteSheetMerger::MakeBigMonstersTargetSheet()
{
    ...
    std::vector<BigMonsterSheet> sheets{
        { "Data/Textures/monstersbig01.png", {
          ...
          { { "BigMonsters/giant_spider.png", { TileMapping{ .SourceTile{ 0, 0, 256, 256 }, .TargetTile{ 1792, 1280, 2048, 1536 } } } } } },
        ...
        { "Data/Textures/monstersbig04.png", {
          ...
          { { "BigMonsters/crab_man.png", { TileMapping{ .SourceTile{ 0, 0, 256, 256 }, .TargetTile{ 512, 512, 768, 768 } }, TileMapping{ .SourceTile{ 256, 0, 512, 256 }, .TargetTile{ 1792, 256, 2048, 512 } } } }, { "BigMonsters/lavamander.png", { TileMapping{ .SourceTile{ 0, 0, 768, 256 }, .TargetTile{ 1280, 1280, 2048, 1536 } } } } } },
        { "Data/Textures/monstersbig05.png", {
          ...
          { { "BigMonsters/eggplant_minister.png", { TileMapping{ .SourceTile{ 0, 0, 512, 128 }, .TargetTile{ 1152, 896, 1664, 1024 } }, TileMapping{ .SourceTile{ 0, 128, 384, 256 }, .TargetTile{ 1664, 896, 2048, 1024 } } } } } },
        ...
        { "Data/Textures/monsters_ghost.png", {
          ...
          {
              { "Ghost/ghist.png", { TileMapping{ .SourceTile{ 0, 0, 384, 128 }, .TargetTile{ 896, 1408, 1280, 1536 } }, TileMapping{ .SourceTile{ 0, 128, 384, 258 }, .TargetTile{ 1280, 1408, 1664, 1536 } }, TileMapping{ .SourceTile{ 0, 256, 128, 384 }, .TargetTile{ 1664, 1408, 1792, 1536 } } } },
          } },
    };
...
void SpriteSheetMerger::MakeCharacterTargetSheet(std::string_view color)
{
    ...
    std::vector<SourceSheet> source_sheets{
        ...
        SourceSheet{ .Path{ fmt::format("Data/Textures/char_{}.png", color) }, .Size{ .Width{ 2048 }, .Height{ 2048 } }, .TileMap = std::vector<TileMapping>{ TileMapping{
                                                                                                                             .SourceTile{ 0, 0, 2048, 1920 },
                                                                                                                             .TargetTile{ 0, 0, 2048, 1920 },
                                                                                                                         } } }
    };
