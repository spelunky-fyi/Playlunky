...
bool DmPreviewMerger::GenerateDmPreview(const std::filesystem::path& source_folder, const std::filesystem::path& destination_folder, VirtualFilesystem& vfs)
{
    ...
    const std::unordered_map<std::string_view, std::uint8_t> known_preview_images{
        { "empty"sv, std::uint8_t{ 0xFF } },
        { "floor"sv, std::uint8_t{ 0x00 } },
        { "push_block"sv, std::uint8_t{ 0x01 } },
        { "crate"sv, std::uint8_t{ 0x02 } },
        { "ladder"sv, std::uint8_t{ 0x03 } },
        { "vines"sv, std::uint8_t{ 0x04 } },
        { "chain"sv, std::uint8_t{ 0x05 } },
        { "pole"sv, std::uint8_t{ 0x06 } },
        { "spikes"sv, std::uint8_t{ 0x07 } },
        { "ceiling_spikes"sv, std::uint8_t{ 0x08 } },
        { "bone_blocks"sv, std::uint8_t{ 0x09 } },
        { "spear_trap"sv, std::uint8_t{ 0x0A } },
        { "falling_platform"sv, std::uint8_t{ 0x0B } },
        { "conveyer_left"sv, std::uint8_t{ 0x0C } },
        { "conveyer_right"sv, std::uint8_t{ 0x0D } },
        { "tnt"sv, std::uint8_t{ 0x0E } },
        { "liquid"sv, std::uint8_t{ 0x0F } },
        { "crush_trap"sv, std::uint8_t{ 0x10 } },
        { "quick_sand"sv, std::uint8_t{ 0x11 } },
        { "ice"sv, std::uint8_t{ 0x12 } },
        { "spring"sv, std::uint8_t{ 0x13 } },
        { "elevator"sv, std::uint8_t{ 0x14 } },
        { "lasers"sv, std::uint8_t{ 0x15 } },
        { "spark_balls"sv, std::uint8_t{ 0x16 } },
        { "regen_blocks"sv, std::uint8_t{ 0x17 } },
        { "tubes"sv, std::uint8_t{ 0x18 } },
        { "foliage"sv, std::uint8_t{ 0x19 } },
    };
